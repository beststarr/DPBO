 ...
 */
 ...
 namespace GtkApp {
    [GtkTemplate (ui = "/org/gtk/ver1/menu.ui")]
    public class MenuPage : Gtk.ApplicationWindow {
        [GtkChild]
        //  private unowned Gtk.Label label;
        //  [GtkChild]
        private unowned Gtk.HeaderBar header_bar;
        [GtkChild]
        private unowned Gtk.Button catatanButton;

        weak Gtk.Application app;

        public MenuPage (Gtk.Application app) {
        ...
        construct{
            ...
            catatanButton.clicked.connect(navigate);
        }
